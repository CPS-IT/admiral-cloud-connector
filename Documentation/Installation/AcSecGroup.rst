...
For the initial setup you have to send a list of usergroups you need for AdmiralCloud. AdmiralCloud will
create these groups (referred to as AC Security Group) and send back a list of ID's.
