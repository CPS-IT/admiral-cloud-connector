...
No. The free version does not have support the AdmiralCloud API. Support of the free version is in planning for
future releases but AdmiralCloud has to make some changes on their side first.
...
Close the connection manually by clicking on "Close connection to AdmiralCloud". This will re-establish the
connection next time you use it:
